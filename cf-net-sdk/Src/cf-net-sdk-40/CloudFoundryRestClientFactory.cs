...
{
    /// <inheritdoc/>
    internal class CloudFoundryRestClientFactory : ICloudFoundryRestClientFactory
    {
        /// <inheritdoc/>
        public ICloudFoundryRestClient Create(IServiceLocator serviceLocator, IPasswordAuthCredential credential, CancellationToken cancellationToken)
        {
            ...
            return new CloudFoundryRestClient(serviceLocator, credential, cancellationToken);
        }
    }
}
